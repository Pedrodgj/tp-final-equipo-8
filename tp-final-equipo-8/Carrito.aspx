      ...
      <div class="mt-8">
        <ul class="space-y-4">
          <li class="flex items-center gap-4">
            <img
              src="https://wiztech.com.ar/assets/images/products/notebook/tuff15_a.png"
              alt=""
              class="h-32 w-32 rounded object-cover"
            />

            <div>
              <h3 class="text-sm text-slate-300">NOMBREPRODUCTO</h3>
              ...
              <form>
                <label for="CANTIDADARTICULO3" class="sr-only"> Cantidad </label>
                  ...
                  <div class="flex items-center gap-1">
                    <button
                      type="button"
                      class="w-10 h-10 leading-10 text-slate-600 transition hover:opacity-75"
                    >
                      &minus;
                    </button>
