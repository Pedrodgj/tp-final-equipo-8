...
<asp:Content ID="Content2" ContentPlaceHolderID="nestedContent" runat="server">
    ...
    <h1 class="mt-6 text-2xl font-bold text-slate-300 sm:text-3xl md:text-4xl pb-3">Agregar producto</h1>
    ...
    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2 w-2/3">
        ...
        <input type="text" id="codigo" class="bg-slate-800 block w-full rounded-md border border-slate-900 px-3 py-2 shadow-sm focus-within:border-slate-600 focus-within:ring-1 focus-within:ring-slate-600" placeholder="Codigo">
        </div>

        <div>
        <label for="Nombre" class=" mb-2 text-sm font-medium text-slate-400">Nombre del producto</label>
        <input type="text" id="nombre" class="bg-slate-800 block w-full rounded-md border border-slate-900 px-3 py-2 shadow-sm focus-within:border-slate-600 focus-within:ring-1 focus-within:ring-slate-600" placeholder="Nombre">
        </div>

        <div>
        <label for="categoria" class=" mb-2 text-sm font-medium text-slate-400">Categoria</label>
        <asp:DropDownList id="categoria" CssClass="bg-slate-800 block w-full rounded-md border border-slate-900 px-3 py-2 shadow-sm focus-within:border-slate-600 focus-within:ring-1 focus-within:ring-slate-600" runat="server">
        ...
        <asp:DropDownList id="marca" CssClass="bg-slate-800 block w-full rounded-md border border-slate-900 px-3 py-2 shadow-sm focus-within:border-slate-600 focus-within:ring-1 focus-within:ring-slate-600" runat="server">
            <asp:ListItem Enabled="true" Text= "Seleccionar" Value= ""></asp:ListItem>
