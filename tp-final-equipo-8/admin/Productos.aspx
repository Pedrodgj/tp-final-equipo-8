  ...
  <table class="min-w-full divide-y-2 divide-slate-700 bg-slate-900 text-sm">
    ...
    <tbody class="divide-y divide-slate-600">
      <tr>
        ...
        <td class="whitespace-nowrap px-4 py-2 text-slate-500">NOMBRE PRODUCTO</td>
        <td class="whitespace-nowrap px-4 py-2 text-slate-500">DESCRIPCION PRODUCTO</td>
        <td class="whitespace-nowrap px-4 py-2 text-slate-500">MARCA PRODUCTO</td>
        <td class="whitespace-nowrap px-4 py-2 text-slate-500">CATEGORIA PRODUCTO</td>
