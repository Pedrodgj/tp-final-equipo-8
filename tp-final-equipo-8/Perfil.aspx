...
>
  <div>
    ...
    <div id="myTabContent">
        ...
        <div class="p-4 rounded-lg bg-slate-900 hidden" id="direcciones" role="tabpanel" aria-labelledby="direcciones-tab">
            <p class="text-slate-400 text-sm">pestaña de direcciones</p>
        </div>
